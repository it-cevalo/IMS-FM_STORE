...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::get('/bank-data', [BankController::class, 'getData'])->name('bank.data'); // <-- Tambahan ini
    Route::resource('bank', BankController::class);    
    Route::get('/cust-data', [CustomerController::class, 'getData'])->name('customers.data'); // <-- Tambahan ini
    ...
    Route::delete('/sku/{kode}', [SKUController::class, 'destroy'])->name('sku.destroy');
    Route::get('/sku/{kode}/edit', [SKUController::class, 'edit'])->name('sku.edit');
    ...
    Route::get('/data', [ProductController::class, 'getData'])->name('product.data');
    ...
    // Route::get('tax_invoice/search', [TaxInvoiceController::class, 'search'])->name('tax_invoice.search');
    ...
    // Route::get('receipt_invoice/search', [ReceiptInvoiceController::class, 'search'])->name('receipt_invoice.search');
