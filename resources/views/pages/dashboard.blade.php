...
<div class="row">
        ...
        <a href="{{route('invoice.index')}}">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-gray-900 text-uppercase mb-1">Product Stock
                            </div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
    ...
    @elseif(Auth::user()->position=='STAFF_FINANCE' || Auth::user()->position=='DIRECTOR')
    <!-- INV (TAX INV) -->
    <div class="col-xl-3 col-md-6 mb-4">
        <a href="{{route('tax_invoice.index')}}">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-gray-900 text-uppercase mb-1">Invoice
                            </div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$total_po}}</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-auto">
