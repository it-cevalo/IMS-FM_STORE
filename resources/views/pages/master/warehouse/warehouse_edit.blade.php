        ...
        <form id="formWarehouseUpdate" method="POST">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" id="exampleFormControlInput1" name="code_wh" type="text"
                    value="{{$warehouses->code_wh}}" placeholder="Input Warehouse Code">
            </div>
            <div class="validation"></div>
            @error('code_wh')
            <div class="alert alert-danger">{{ $message }}</div>
            ...
            <div class="mb-3">
                ...
                <input class="form-control" id="exampleFormControlInput1" name="nama_wh" type="text"
                    value="{{$warehouses->nama_wh}}" placeholder="Input Warehouse Name">
            </div>
            <div class="validation"></div>
            @error('nama_wh')
            <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            <div class="mb-3">
                <label for="exampleFormControlInput1">Warehouse Phone</label>
                <input class="form-control" id="exampleFormControlInput1" name="phone" type="number" min="0"
                    value="{{$warehouses->phone}}" placeholder="Input Warehouse Phone">
            </div>
            <div class="validation"></div>
            @error('phone')
            <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            <div class="mb-3">
                <label for="exampleFormControlInput1">Warehouse Email</label>
                <input class="form-control" id="exampleFormControlInput1" name="email" type="email"
                    value="{{$warehouses->email}}" placeholder="Input Warehouse Email">
            </div>
            <div class="validation"></div>
            @error('email')
            <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            <div class="mb-3">
                <label for="exampleFormControlInput1">Warehouse Address</label>
                <input class="form-control" id="exampleFormControlInput1" name="address" type="text"
                    value="{{$warehouses->address}}" placeholder="Input Warehouse Address">
            </div>
            <div class="validation"></div>
            @error('address')
            <div class="alert alert-danger">{{ $message }}</div>
