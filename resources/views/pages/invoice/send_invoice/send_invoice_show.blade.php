    ...
    <div class="card-body">
        <form action="{{route('send_invoice.update',$send_invoice->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="exampleFormControlInput1">Invoice</label>
                    <div class="input-group">
                            <select class="form-control" name="id_inv_rcp" value="{{old('id_inv_rcp')}}" disabled>
                                <option value="">....</option>
            ...
            <div class="validation"></div>
                ...
                @enderror
            <div class="mb-3">
                <label for="exampleFormControlInput1">Receipt Document</label><br/>
                <a href="{{$send_invoice->bukti_tanda_terima}}" target="__blank">
                    <image src="{{$send_invoice->bukti_tanda_terima}}" />
                </a>
            </div>
            <div class="validation"></div>
