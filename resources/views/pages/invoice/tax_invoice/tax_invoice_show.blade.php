...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" id="exampleFormControlInput1" name="no_inv" value="{{$tax_invoice->no_inv}}" type="text" placeholder="Input Invoice Number" disabled>
            </div>
            <div class="validation"></div>
                @error('no_inv')
                  <div class="alert alert-danger">{{ $message }}</div>
            ...
            <div class="mb-3">
                ...
                @if($tax_invoice->signed)
                    <img src="{{asset($tax_invoice->signed)}}">
                @else
