        ...
        <form action="{{route('tax_invoice.update',$tax_invoice->id)}}" method="POST">
            ...
            @if(Auth::user()->position=='DIRECTOR')
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" id="exampleFormControlInput1" name="no_inv" value="{{$tax_invoice->no_inv}}" type="text" placeholder="Input Invoice Number" readonly>
                </div>
                <div class="validation"></div>
                    @error('no_inv')
                    <div class="alert alert-danger">{{ $message }}</div>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" id="exampleFormControlInput1" name="no_seri_pajak" value="{{$tax_invoice->no_seri_pajak}}" type="text" placeholder="Input Tax Code" disabled>
                </div>
                <div class="validation"></div>
                    @error('no_seri_pajak')
                    <div class="alert alert-danger">{{ $message }}</div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="exampleFormControlInput1" name="reason_faktur_pajak" value="{{$tax_invoice->reason_faktur_pajak}}"  type="text" placeholder="Input Reason" disabled>{{$tax_invoice->reason_faktur_pajak}}</textarea>
                </div>
                <div class="validation"></div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="exampleFormControlInput1" name="reason_inv" value="{{$tax_invoice->reason_inv}}" type="text" placeholder="Input Invoice Reason" disabled></textarea>
                </div>
                <div class="validation"></div>
                    @error('reason_inv')
                    <div class="alert alert-danger">{{ $message }}</div>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" id="exampleFormControlInput1" name="grand_total" value="{{$tax_invoice->grand_total}}"  type="number" min="0" placeholder="Input Grand Total" disabled></input>
                </div>
                <div class="validation"></div>
                    @error('grand_total')
                    <div class="alert alert-danger">{{ $message }}</div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="exampleFormControlInput1" name="term" type="text" value="{{$tax_invoice->term}}" placeholder="Input Term" disabled></textarea>
                </div>
                <div class="validation"></div>
                    @error('term')
                    <div class="alert alert-danger">{{ $message }}</div>
                ...
                <div class="mb-3">
                    ...
                    <!-- <textarea class="form-control" id="exampleFormControlInput1" name="term" type="text" value="{{$tax_invoice->term}}" placeholder="Input Term" required></textarea> -->
                </div>
                <div class="validation"></div>
                    @error('term')
                    <div class="alert alert-danger">{{ $message }}</div>
            ...
            @else 
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1">Reason</label>
                    <textarea class="form-control" id="exampleFormControlInput1" name="reason_faktur_pajak" value="{{$tax_invoice->reason_faktur_pajak}}"  type="text" placeholder="Input Reason" required>{{$tax_invoice->reason_faktur_pajak}}</textarea>
                </div>
                <div class="validation"></div>
                    @error('reason_faktur_pajak')
                    <div class="alert alert-danger">{{ $message }}</div>
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1">Invoice Reason</label>
                    <textarea class="form-control" id="exampleFormControlInput1" name="reason_inv" value="{{$tax_invoice->reason_inv}}" type="text" placeholder="Input Invoice Reason" required></textarea>
                </div>
                <div class="validation"></div>
                    @error('reason_inv')
                    <div class="alert alert-danger">{{ $message }}</div>
