    ...
    <div class="card-body">
        <form action="{{route('payment.update',$payment->id)}}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" id="exampleFormControlInput1" value="{{$payment->invoice_paid}}" name="invoice_paid" type="number" min="0" placeholder="Input Invoice Paid" onkeypress="return /[0-9a-zA-Z]/i.test(event.key)" disabled>
            </div>
            <div class="validation"></div>
                @error('invoice_paid')
                  <div class="alert alert-danger">{{ $message }}</div>
            ...
            <div class="mb-3">
                ...
                <input class="form-control" id="exampleFormControlInput1" value="{{$payment->amount_paid}}" name="amount_paid" type="number" min="0" placeholder="Input Amount Paid" onkeypress="return /[0-9a-zA-Z]/i.test(event.key)" required>
            </div>
            <div class="validation"></div>
                @error('amount_paid')
                  <div class="alert alert-danger">{{ $message }}</div>
